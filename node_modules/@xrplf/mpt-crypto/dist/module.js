...
exports.loadWasmModule = exports.loadWithRetry = void 0;
let cached;
...
async function loadOnce() {
    ...
    const { default: factory } = await Promise.resolve().then(() => __importStar(require(
 ...
 */
async function loadWithRetry(load = loadOnce, attempt = 1) {
    try {
        return await load();
    }
    catch (error) {
...
exports.loadWithRetry = loadWithRetry;
/**
