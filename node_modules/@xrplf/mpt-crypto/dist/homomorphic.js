...
exports.subtractCiphertexts = exports.addCiphertexts = void 0;
...
async function combineCiphertexts(a, b, op) {
    const aBytes = (0, hex_1.hexToBytes)(a, 'a', constants_1.ELGAMAL_TOTAL_SIZE);
    const bBytes = (0, hex_1.hexToBytes)(b, 'b', constants_1.ELGAMAL_TOTAL_SIZE);
 ...
 * @throws If either input is malformed or a WASM call fails.
 */
async function addCiphertexts(a, b) {
    return combineCiphertexts(a, b, 'add');
}
exports.addCiphertexts = addCiphertexts;
/**
 ...
 * @throws If either input is malformed or a WASM call fails.
 */
async function subtractCiphertexts(a, b) {
    return combineCiphertexts(a, b, 'subtract');
}
exports.subtractCiphertexts = subtractCiphertexts;
//# sourceMappingURL=homomorphic.js.map