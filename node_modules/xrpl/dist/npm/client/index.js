...
class Client extends eventemitter3_1.EventEmitter {
    constructor(server, options = {}) {
        ...
        if (options.authorization != null &&
            ...
            throw new errors_1.ValidationError('Authorization Credentials cannot be sent over an unencrypted connection. Use wss:// or wss+unix:// instead.');
        }
    ...
    autofill(transaction, signersCount, sponsorSignersCount) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tx.Fee == null) {
                promises.push((0, autofill_1.getTransactionFee)(this, tx, signersCount, sponsorSignersCount));
            }
    ...
    prepareTransaction(transaction, signersCount, sponsorSignersCount) {
        return __awaiter(this, void 0, void 0, function* () {
