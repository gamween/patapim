...
exports.addPreFundedSponsor = exports.combineSponsorSigners = exports.signAsSponsor = exports.combineLoanSetCounterpartySigners = exports.signLoanSetByCounterparty = exports.authorizeChannel = exports.verifySignature = exports.multisign = exports.combineBatchSigners = exports.signMultiBatch = exports.Wallet = void 0;
...
class Wallet {
    ...
    static fromMnemonic(mnemonic, opts = {}) {
        ...
        if (!(0, bip39_1.validateMnemonic)(mnemonic, english_js_1.wordlist)) {
        ...
        const node = masterNode.derive((_b = opts.derivationPath) !== null && _b !== void 0 ? _b : DEFAULT_DERIVATION_PATH);
        validateKey(node);
    ...
    static fromRFC1751Mnemonic(mnemonic, opts) {
        ...
        let encodeAlgorithm;
        if (opts.algorithm === ECDSA_1.default.secp256k1) {
...
var counterpartySigner_1 = require("./counterpartySigner");
...
var sponsorSigner_1 = require("./sponsorSigner");
Object.defineProperty(exports, "signAsSponsor", { enumerable: true, get: function () { return sponsorSigner_1.signAsSponsor; } });
Object.defineProperty(exports, "combineSponsorSigners", { enumerable: true, get: function () { return sponsorSigner_1.combineSponsorSigners; } });
Object.defineProperty(exports, "addPreFundedSponsor", { enumerable: true, get: function () { return sponsorSigner_1.addPreFundedSponsor; } });
