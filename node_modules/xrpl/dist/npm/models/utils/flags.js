...
exports.parseTransactionFlags = exports.convertTxFlagsToNumber = exports.setTransactionFlagsToNumber = exports.parseMPTokenIssuanceImmutableFlags = exports.parseMPTokenIssuanceFlags = exports.parseAccountRootFlags = void 0;
const errors_1 = require("../../errors");
const AccountRoot_1 = require("../ledger/AccountRoot");
const MPTokenIssuance_1 = require("../ledger/MPTokenIssuance");
...
const loanPay_1 = require("../transactions/loanPay");
...
const sponsorshipSet_1 = require("../transactions/sponsorshipSet");
const sponsorshipTransfer_1 = require("../transactions/sponsorshipTransfer");
...
function parseMPTokenIssuanceFlags(flags) {
    const flagsInterface = {};
    Object.values(MPTokenIssuance_1.MPTokenIssuanceFlags).forEach((flag) => {
        if (typeof flag === 'string' &&
            (0, _1.isFlagEnabled)(flags, MPTokenIssuance_1.MPTokenIssuanceFlags[flag])) {
            flagsInterface[flag] = true;
        }
    });
    return flagsInterface;
}
exports.parseMPTokenIssuanceFlags = parseMPTokenIssuanceFlags;
function parseMPTokenIssuanceImmutableFlags(flags) {
    const flagsInterface = {};
    if (flags == null) {
        return flagsInterface;
    }
    Object.values(MPTokenIssuance_1.MPTokenIssuanceImmutableFlags).forEach((flag) => {
        if (typeof flag === 'string' &&
            (0, _1.isFlagEnabled)(flags, MPTokenIssuance_1.MPTokenIssuanceImmutableFlags[flag])) {
            flagsInterface[flag] = true;
        }
    });
    return flagsInterface;
}
exports.parseMPTokenIssuanceImmutableFlags = parseMPTokenIssuanceImmutableFlags;
const txToFlag = {
    ...
    SponsorshipSet: sponsorshipSet_1.SponsorshipSetFlags,
    SponsorshipTransfer: sponsorshipTransfer_1.SponsorshipTransferFlags,
