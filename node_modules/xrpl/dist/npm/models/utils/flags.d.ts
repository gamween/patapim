...
import { MPTokenIssuanceFlagsInterface, MPTokenIssuanceImmutableFlagsInterface } from '../ledger/MPTokenIssuance';
import type { Transaction } from '../transactions/transaction';
export declare function parseAccountRootFlags(flags: number): AccountRootFlagsInterface;
export declare function parseMPTokenIssuanceFlags(flags: number): MPTokenIssuanceFlagsInterface;
export declare function parseMPTokenIssuanceImmutableFlags(flags: number | undefined): MPTokenIssuanceImmutableFlagsInterface;
