...
import { ConfidentialMPTClawback } from './ConfidentialMPTClawback';
import { ConfidentialMPTConvert } from './ConfidentialMPTConvert';
import { ConfidentialMPTConvertBack } from './ConfidentialMPTConvertBack';
import { ConfidentialMPTMergeInbox } from './ConfidentialMPTMergeInbox';
import { ConfidentialMPTSend } from './ConfidentialMPTSend';
...
import { SponsorshipSet } from './sponsorshipSet';
import { SponsorshipTransfer } from './sponsorshipTransfer';
...
export type SubmittableTransaction = AMMBid | AMMClawback | AMMCreate | AMMDelete | AMMDeposit | AMMVote | AMMWithdraw | AccountDelete | AccountSet | Batch | CheckCancel | CheckCash | CheckCreate | Clawback | ConfidentialMPTClawback | ConfidentialMPTConvert | ConfidentialMPTConvertBack | ConfidentialMPTMergeInbox | ConfidentialMPTSend | CredentialAccept | CredentialCreate | CredentialDelete | DIDDelete | DIDSet | DelegateSet | DepositPreauth | EscrowCancel | EscrowCreate | EscrowFinish | LoanBrokerSet | LoanBrokerCoverClawback | LoanBrokerCoverDeposit | LoanBrokerCoverWithdraw | LoanBrokerDelete | LoanSet | LoanDelete | LoanManage | LoanPay | MPTokenAuthorize | MPTokenIssuanceCreate | MPTokenIssuanceDestroy | MPTokenIssuanceSet | NFTokenAcceptOffer | NFTokenBurn | NFTokenCancelOffer | NFTokenCreateOffer | NFTokenMint | NFTokenModify | OfferCancel | OfferCreate | OracleDelete | OracleSet | Payment | PaymentChannelClaim | PaymentChannelCreate | PaymentChannelFund | PermissionedDomainSet | PermissionedDomainDelete | SetRegularKey | SignerListSet | SponsorshipSet | SponsorshipTransfer | TicketCreate | TrustSet | VaultClawback | VaultCreate | VaultDelete | VaultDeposit | VaultSet | VaultWithdraw | XChainAccountCreateCommit | XChainAddAccountCreateAttestation | XChainAddClaimAttestation | XChainClaim | XChainCommit | XChainCreateBridge | XChainCreateClaimID | XChainModifyBridge;
