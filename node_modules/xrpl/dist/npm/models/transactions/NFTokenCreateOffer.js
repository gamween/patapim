...
function validateNFTokenCreateOffer(tx) {
    ...
    if ((0, common_1.isString)(tx.Account) &&
        (0, common_1.isString)(tx.Owner) &&
        (0, common_1.areAddressesEqual)(tx.Account, tx.Owner)) {
        throw new errors_1.ValidationError('NFTokenCreateOffer: Owner and Account must not be equal');
    }
    if ((0, common_1.isString)(tx.Account) &&
        (0, common_1.isString)(tx.Destination) &&
        (0, common_1.areAddressesEqual)(tx.Account, tx.Destination)) {
