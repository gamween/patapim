...
exports.validateMPTokenIssuanceCreate = exports.tifMPTokenIssuanceImmutableMask = exports.MPTokenIssuanceCreateImmutableFlags = exports.MPTokenIssuanceCreateFlags = exports.MAX_TRANSFER_FEE = void 0;
const errors_1 = require("../../errors");
const utils_1 = require("../utils");
const mptokenMetadata_1 = require("../utils/mptokenMetadata");
const common_1 = require("./common");
const MAX_AMT = '9223372036854775807';
exports.MAX_TRANSFER_FEE = 50000;
...
(function (MPTokenIssuanceCreateFlags) {
    ...
    MPTokenIssuanceCreateFlags[MPTokenIssuanceCreateFlags["tfMPTCanHoldConfidentialBalance"] = 128] = "tfMPTCanHoldConfidentialBalance";
})(MPTokenIssuanceCreateFlags || (exports.MPTokenIssuanceCreateFlags = MPTokenIssuanceCreateFlags = {}));
var MPTokenIssuanceCreateImmutableFlags;
(function (MPTokenIssuanceCreateImmutableFlags) {
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTCanLock"] = 2] = "tifMPTCanLock";
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTRequireAuth"] = 4] = "tifMPTRequireAuth";
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTCanEscrow"] = 8] = "tifMPTCanEscrow";
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTCanTrade"] = 16] = "tifMPTCanTrade";
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTCanTransfer"] = 32] = "tifMPTCanTransfer";
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTCanClawback"] = 64] = "tifMPTCanClawback";
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTCanHoldConfidentialBalance"] = 128] = "tifMPTCanHoldConfidentialBalance";
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTMetadata"] = 65536] = "tifMPTMetadata";
    MPTokenIssuanceCreateImmutableFlags[MPTokenIssuanceCreateImmutableFlags["tifMPTTransferFee"] = 131072] = "tifMPTTransferFee";
})(MPTokenIssuanceCreateImmutableFlags || (exports.MPTokenIssuanceCreateImmutableFlags = MPTokenIssuanceCreateImmutableFlags = {}));
exports.tifMPTokenIssuanceImmutableMask = ~(MPTokenIssuanceCreateImmutableFlags.tifMPTCanLock |
...
function validateMPTokenIssuanceCreate(tx) {
    ...
    (0, common_1.validateOptionalField)(tx, 'ImmutableFlags', common_1.isNumber);
    (0, common_1.validateOptionalField)(tx, 'DomainID', common_1.isDomainID);
    if (tx.DomainID != null &&
        !(0, utils_1.hasFlag)(tx, MPTokenIssuanceCreateFlags.tfMPTRequireAuth, 'tfMPTRequireAuth')) {
        throw new errors_1.ValidationError('MPTokenIssuanceCreate: Cannot set DomainID unless tfMPTRequireAuth flag is set.');
    }
    if (typeof tx.ImmutableFlags === 'number') {
        const invalidBits = tx.ImmutableFlags & exports.tifMPTokenIssuanceImmutableMask;
        if (tx.ImmutableFlags === 0 || invalidBits !== 0) {
            throw new errors_1.ValidationError('MPTokenIssuanceCreate: Invalid ImmutableFlags value');
        }
    }
    ...
    if (typeof tx.TransferFee === 'number') {
        ...
        const isTfMPTCanHoldConfidentialBalance = typeof flags === 'number'
            ? (0, utils_1.isFlagEnabled)(flags, MPTokenIssuanceCreateFlags.tfMPTCanHoldConfidentialBalance)
            : ((_c = flags.tfMPTCanHoldConfidentialBalance) !== null && _c !== void 0 ? _c : false);
        if (tx.TransferFee < 0 || tx.TransferFee > exports.MAX_TRANSFER_FEE) {
            throw new errors_1.ValidationError(`MPTokenIssuanceCreate: TransferFee must be between 0 and ${exports.MAX_TRANSFER_FEE}`);
        }
        ...
        if (tx.TransferFee && isTfMPTCanHoldConfidentialBalance) {
            throw new errors_1.ValidationError('MPTokenIssuanceCreate: TransferFee cannot be provided together with the tfMPTCanHoldConfidentialBalance flag');
        }
    }
