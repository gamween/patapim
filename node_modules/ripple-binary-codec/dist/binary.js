...
function multiSigningData(transaction, signingAccount, opts = {}) {
    var _a, _b;
    const prefix = (_a = opts.prefix) !== null && _a !== void 0 ? _a : hash_prefixes_1.HashPrefix.transactionMultiSig;
    const suffix = types_1.coreTypes.AccountID.from(signingAccount).toBytes();
    return serializeObject(transaction, {
        prefix,
        suffix,
        signingFieldsOnly: true,
        definitions: (_b = opts.definitions) !== null && _b !== void 0 ? _b : enums_1.DEFAULT_DEFINITIONS,
    });
}
