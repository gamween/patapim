 ...
 * @returns a hex string of the encoded transaction.
 */
function encodeForSigningCounterparty(json, definitions) {
    if (typeof json !== 'object') {
        throw new Error();
    }
    return (0, utils_1.bytesToHex)(signingData(json, coretypes_1.HashPrefix.counterpartyTransactionSig, {
        definitions,
    }));
}
exports.encodeForSigningCounterparty = encodeForSigningCounterparty;
/**
 ...
 * @returns a hex string of the encoded transaction.
 */
function encodeForMultisigningCounterparty(json, signer, definitions) {
    if (typeof json !== 'object') {
        throw new Error();
    }
    return (0, utils_1.bytesToHex)(multiSigningData(json, signer, {
        prefix: coretypes_1.HashPrefix.counterpartyTransactionMultiSig,
        definitions,
    }));
}
exports.encodeForMultisigningCounterparty = encodeForMultisigningCounterparty;
/**
 ...
 * @returns a hex string of the encoded transaction.
 */
function encodeForSigningSponsor(json, definitions) {
    if (typeof json !== 'object') {
        throw new Error();
    }
    return (0, utils_1.bytesToHex)(signingData(json, coretypes_1.HashPrefix.sponsorTransactionSig, {
        definitions,
    }));
}
exports.encodeForSigningSponsor = encodeForSigningSponsor;
/**
 ...
 * @returns a hex string of the encoded transaction.
 */
function encodeForMultisigningSponsor(json, signer, definitions) {
    if (typeof json !== 'object') {
        throw new Error();
    }
    return (0, utils_1.bytesToHex)(multiSigningData(json, signer, {
        prefix: coretypes_1.HashPrefix.sponsorTransactionMultiSig,
        definitions,
    }));
}
exports.encodeForMultisigningSponsor = encodeForMultisigningSponsor;
/**
