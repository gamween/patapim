 ...
 * @returns a hex string of the encoded transaction.
 */
declare function encodeForSigningCounterparty(json: object, definitions?: XrplDefinitionsBase): string;
/**
 ...
 * @returns a hex string of the encoded transaction.
 */
declare function encodeForMultisigningCounterparty(json: object, signer: string, definitions?: XrplDefinitionsBase): string;
/**
 ...
 * @returns a hex string of the encoded transaction.
 */
declare function encodeForSigningSponsor(json: object, definitions?: XrplDefinitionsBase): string;
/**
 ...
 * @returns a hex string of the encoded transaction.
 */
declare function encodeForMultisigningSponsor(json: object, signer: string, definitions?: XrplDefinitionsBase): string;
/**
...
export { decode, encode, encodeForSigning, encodeForSigningClaim, encodeForMultisigning, encodeForSigningCounterparty, encodeForMultisigningCounterparty, encodeForSigningSponsor, encodeForMultisigningSponsor, encodeForSigningBatch, encodeQuality, decodeQuality, decodeLedgerData, TRANSACTION_TYPES, XrplDefinitions, XrplDefinitionsBase, DEFAULT_DEFINITIONS, coreTypes, };
