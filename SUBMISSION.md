...
| ☑ | Slide deck, ten slides maximum | ten slides (Track 2, Loaded, KPI evidence, then developer feedback and contribution), [live](https://ways-stake-equations-suitable.trycloudflare.com/deck/index.html) and [`docs/PATAPIM-DECK.pdf`](./docs/PATAPIM-DECK.pdf) |
